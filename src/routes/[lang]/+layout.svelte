<script lang="ts">
	...
	// First, we use our default SEO values
	// Then we apply any SEO data from Sanity (layout data)
	// Finally, we ensure ogUrl and canonical are properly set
...
<svelte:head>
	...
	{#if pageSeo.alternateLanguages && typeof pageSeo.alternateLanguages === 'object'}
		{#each Object.entries(pageSeo.alternateLanguages as Record<string, string>) as [lang, url]}
